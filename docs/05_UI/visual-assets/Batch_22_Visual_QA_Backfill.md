...
> Base：`main@475949e8d07c99683776faa63c88543e96e8d250`  
> 状态：IN PROGRESS

## 1. 目标

将 `Visual_QA_Contract_v1.0.md` 追溯应用到已合入 Wave A–E 的全部 macOS 视觉系统与生产组件。历史代码不豁免。
...
- Component Gallery
- Wave E Overlay / Feedback specimen
...
- 新增 contract tests；
- Wave E Overlay/Feedback 同样通过相同 QA Contract；
